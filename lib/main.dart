...
import 'package:flutter_first/controller/my_permission_photo.dart';
...
import 'package:flutter_first/view/my_dashboard.dart';
import 'package:flutter_first/view/my_loading.dart';
                        ...
                        onPressed: () {
                          MyFirebaseHelper()
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const MyDashBoard(title: '',)));
                          }).catchError((onError) {
                            //afficher un pop
                            popError();
                          });
